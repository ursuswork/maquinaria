...
<div class="container py-5">
  ...
  <form method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="modelo" class="form-control" value="<?= $row['modelo'] ?>" required>
    </div>
    <div class="mb-3">
      <label class="form-label">Ubicación</label>
      <input type="text" name="ubicacion" class="form-control" value="<?= $row['ubicacion'] ?>" required>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="number" name="condicion_estimada" class="form-control" value="<?= $row['condicion_estimada'] ?>" min="0" max="100" required>
    </div>
    <div class="mb-3">
      <label class="form-label">Imagen (dejar en blanco para no cambiar)</label>
