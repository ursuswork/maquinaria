...
<tr>
  ...
  <td>
    ...
    <?php
          ...
          ?>
            <a href="acciones/recibo_unidad.php?id=<?= $fila['id'] ?>" class="btn btn-sm btn-outline-warning" title="Ver Recibo"><i class="bi bi-file-earmark-text"></i></a>
          <?php elseif ($fila['tipo_maquinaria'] == 'nueva' && isset($mapa_avance[$subtipo])): ?>
...
<a href="exportar_excel.php" class="btn-flotante">📥 Exportar Excel</a>
  ...
  <a href="exportar_excel.php" class="btn btn-success position-fixed bottom-0 end-0 m-4 shadow-lg rounded-pill px-4 py-2">
    📥 Exportar a Excel
  </a>
</body>
</html>