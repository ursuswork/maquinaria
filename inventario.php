...
<head>
  ...
  <style>
    ...
    .progress { background-color: #333; height: 25px; }
      ...
      <div class="col-md-4 mb-4">
        <div class="card card-maquinaria p-3 text-light">
          ...
          if (strtolower(trim($fila['tipo_maquinaria'])) == 'nueva') {
            if (strtolower(trim($fila['subtipo'])) == 'esparcidor de sello') {
            ...
            } elseif (strtolower(trim($fila['subtipo'])) == 'petrolizadora') {
          ...
          <?php elseif (
            ...
            <a href="avance_petrolizadora.php?id=<?= $fila['id'] ?>" class="btn btn-sm btn-outline-success mt-2 w-100">🛠️ Ver Avance</a>
          <?php endif; ?>
        </div>
      </div>
    <?php endwhile; ?>
