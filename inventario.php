...
<div class="container py-4">
  ...
  <table class="table table-hover table-bordered">
    ...
    <tbody>
      ...
      ?>
      <tr>
        <td><?php if (!empty($fila['imagen'])): ?><img src="imagenes/<?= htmlspecialchars($fila['imagen']) ?>" alt="Imagen" class="imagen-thumbnail" onclick="ampliarImagen(this)"><?php else: ?><span class="text-muted">Sin imagen</span><?php endif; ?></td>
        <td><?= htmlspecialchars($fila['nombre']) ?></td>
        <td><?= htmlspecialchars($fila['modelo']) ?></td>
        <td><?= htmlspecialchars($fila['ubicacion']) ?></td>
        <td><?= $fila['tipo_maquinaria'] == 'nueva' ? '<span class="badge-nueva">Producción Nueva</span>' : 'Usada' ?></td>
        ...
        <td>
          ...
          <?php
            $mapa_avance = ['bachadora' => 'avance_bachadora.php'];
