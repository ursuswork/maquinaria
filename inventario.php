...
<?php while($fila=$resultado->fetch_assoc()):
  ...
  // Calcular avance para maquinaria nueva
  if($tipo_maq==='nueva'){
...
?>
      <tr>
        ...
        <td>
          <a href="editar_maquinaria.php?id=<?=$id?>" class="btn btn-sm btn-outline-primary me-1"><i class="bi bi-pencil-square"></i></a>
          <a href="eliminar_maquinaria.php?id=<?=$id?>" class="btn btn-sm btn-outline-danger me-1" onclick="return confirm('¿Eliminar?')"><i class="bi bi-trash"></i></a>
          <?php if($tipo_maq==='usada'): ?>
