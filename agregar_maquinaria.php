...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->bind_param("sssssis", $nombre, $tipo, $modelo, $ubicacion, $tipo_maquinaria, $condicion, $imagen);
    $stmt->execute();
...
<div class="container py-5">
  ...
  <form method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <input type="number" name="condicion_estimada" class="form-control" min="0" max="100" required>
    </div>
    <div class="mb-3">
